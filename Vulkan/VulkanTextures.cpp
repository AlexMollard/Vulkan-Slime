...
bool vkutil::load_image_from_file(VulkanEngine &engine, const char *file, vktype::AllocatedImage &outImage) {
    ...
    vktype::AllocatedBuffer stagingBuffer = engine.create_buffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
    ...
    vktype::AllocatedImage newImage;
