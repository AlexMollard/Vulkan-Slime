...
AllocatedImage vkutil::upload_image(int texWidth, int texHeight, VkFormat image_format, VulkanEngine& engine, AllocatedBufferUntyped& stagingBuffer)
{
    ...
    VkImageCreateInfo dimg_info = vkslime::image_create_info(image_format, VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT, imageExtent);
    ...
    VkImageViewCreateInfo view_info = vkslime::imageview_create_info(image_format, newImage.mImage, VK_IMAGE_ASPECT_COLOR_BIT);
